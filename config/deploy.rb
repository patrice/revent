...
task :after_symlink, :roles => :app , :except => {:no_symlink => true} do
  run <<-CMD
    ...
    mkdir #{release_path}/public/reports &&
    ln -nfs #{release_path}/public/index.html #{release_path}/public/reports/index.html &&
    mkdir -p #{release_path}/public/truemajority/reports &&
    ln -nfs #{release_path}/public/truemajority/index.html #{release_path}/public/truemajority/reports/index.html
  CMD
end 
